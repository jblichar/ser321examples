      ...
      if (request == null) {
        ...
        if (request.length() == 0) {
          ...
          try {
            ...
            try {
              ...
              try {
                ...
                builder.append("HTTP/1.1 200 OK, product calculated correctly\n");
                builder.append("Content-Type: text/html; charset=utf-8\n");
                builder.append("\n");
                builder.append("Result is: " + product);
              } catch (Exception e) {
                builder.append("HTTP/1.1 412 Precondition Failed, values provided are too large.\n");
                builder.append("Content-Type: text/html; charset=utf-8\n");
                builder.append("\n");
                builder.append("Please try again with smaller values.");
              }
            } catch (Exception e) {
              num2 = Long.parseLong("78");
              try {
                Long product = num1 * num2;
                builder.append("HTTP/1.1 200 OK, single value provided. Product calculated using default number.\n");
                builder.append("Content-Type: text/html; charset=utf-8\n");
                builder.append("\n");
                builder.append("Result is: " + product);
              } catch (Exception b) {
            ...
            builder.append("HTTP/1.1 400 Bad Request, Parameters are missing\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Parameters missing. At least one value is required.");
          }
          ...
          try {
            ...
            try {
              ...
              for (int i = 0; i < repoArray.length(); i++) {
                ...
                builder.append("{<br>&emsp;\"fullname\":" + repoName + ",<br>");
                builder.append("&emsp;\"id\": " + repoID + ",<br>");
                builder.append("&emsp;\"loginname\": " + ownername + "<br>}<br>");
              }
              builder.append("]<br>");
            } catch (Exception e) {
              builder.append("HTTP/1.1 404 Not Found, Invalid URL provided\n");
              builder.append("Content-Type: text/html; charset=utf-8\n");
              builder.append("\n");
              builder.append("Invalid URL. Try calling using the following format - host:PORT/github?query=users/username/repos");
            }
          } catch (Exception e) {
            builder.append("HTTP/1.1 400 Bad Request, Parameters are missing\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Parameters missing. Try calling using the following format - host:PORT/github?query=users/username/repos");
          }
          ...
          try {
            ...
            num1 = Long.parseLong(query_pairs.get("rad"));
             try {
               ...
               try {
                 ...
                 builder.append("HTTP/1.1 200 OK, volume calculated correctly\n");
                 builder.append("Content-Type: text/html; charset=utf-8\n");
                 builder.append("\n");
                 builder.append("Volume is: " + volume);
               } catch (Exception e) {
                 builder.append("HTTP/1.1 412 Precondition Failed, values provided are too large.\n");
                 builder.append("Content-Type: text/html; charset=utf-8\n");
                 builder.append("\n");
               ...
               try {
                 Double volume = Math.PI * num1 * num1 * (num2 / 3);
                 builder.append("HTTP/1.1 200 OK, single value provided. Volume calculated using default number.\n");
                 builder.append("Content-Type: text/html; charset=utf-8\n");
                 builder.append("\n");
                 builder.append("Volume is: " + volume);
               } catch (Exception b) {
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Parameters missing. Radius and height values are required.");
          }
          ...
          try {
            ...
            String start = query_pairs.get("curr");
            try {
              String end = query_pairs.get("conv");
              try {
                String json = fetchURL("https://cdn.jsdelivr.net/gh/fawazahmed0/currency-api@1/latest/currencies/" + start + "/" + end + ".json");
                System.out.println(json);
                JSONObject obj = new JSONObject(json);
                String date = obj.getString("date");
                Double currency = obj.getDouble(end);
                ...
                builder.append("\n");
                builder.append("[<br>");
                builder.append("{<br>&emsp;\"date\": " + date + ",<br>");
                builder.append("&emsp;\"" + end + "\": " + currency + "<br>}<br>]");
              } catch (Exception e) {
                builder.append("HTTP/1.1 404 Not Found, Invalid URL provided\n");
                builder.append("Content-Type: text/html; charset=utf-8\n");
                builder.append("\n");
                builder.append("Invalid URL. Try using valid currency codes (i.e. eur, jpy, usd, etc.)");
              }
            } catch (Exception e) {
              String end = "usd";
              try {
                ...
                builder.append("HTTP/1.1 200 OK, Only one parameter provided. Using USD as default\n");
                builder.append("Content-Type: text/html; charset=utf-8\n");
                builder.append("\n");
                builder.append("[<br>");
                builder.append("{<br>&emsp;\"date\": " + date + ",<br>");
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("At least on parameter is required. Try calling using the following format - host:port/currency?curr={choose currency to be converted}&conv{desired currency}");
          }
        } else {
